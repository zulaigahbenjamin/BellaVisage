    ...
    <div class="category" id="category">
      <div class="category-title">
        <h2
          ...
          "
        >
          GRAB ALL YOU NEED FOR FABULOUS, CLEAR AND GLOWING SKIN!
        </h2>
        <h2
          style="
            margin: 1rem;
      ...
      <ul class="cardz" style="height: 40rem; width: 100% !important">
        <li class="kard">
          <div>
            ...
            <div class="card-content">
              <p>
                BellaVisage's luxurious experience, these top-tier body skincare
                products elevate self-care routines while promoting healthy,
                radiant skin.
              </p>
            </div>
          </div>
        ...
        <li class="kard">
          <div>
            ...
            <div class="card-content">
              <p>
                It's Skin's serums with targeted benefits help you customize to
                your specific skin care needs. Find one that's right for you.
              </p>
            </div>
          </div>
          <div class="card-link-wrapper">
        ...
        <li class="kard">
          <div>
            ...
            <div class="card-content">
              <p>
                For you you skincare enthusiasts looking to take your your
                skincare game to the next level. Products included.
              </p>
            </div>
          </div>
          <div class="card-link-wrapper">
        ...
        <li class="kard">
          <div>
            ...
            <div class="card-content">
              <p>
                A quickly daily routine for people on the go. Learn in the
                basics of Korean Beauty skincare routine. You will never look
                back.
              </p>
            </div>
          </div>
        ...
        <li class="kard">
          <div>
            ...
            <div class="card-content">
              <p>
                Don't slip up on your skin care routine. Keep your skin glowing
                and protected for fun in the sun with this month's best sellers.
              </p>
            </div>
          </div>
          <div class="card-link-wrapper">
        ...
        <li class="kard">
          <div>
            ...
            <div class="card-content">
              <p>
                BellaVisage's essential skin oil deliver's impeccable blend of
                natural botanicals and cutting-edge formulation for nourishing,
