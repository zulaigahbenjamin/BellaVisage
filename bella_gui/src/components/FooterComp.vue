...
<footer class="text-center text-lg-start  text-muted">
    ...
    <section class="d-flex justify-content-center justify-content-lg-between p-4 border-bottom">
      ...
      <div>
        ...
        <a href="https://www.whatsapp.com/" target="_blank" class="me-4 text-reset">
          <i style="color: #25D366;" class="fa-brands fa-square-whatsapp"></i>
        </a>
      </div>
      <!-- Right -->
    </section>
      ...
      <div class="container text-center text-md-start mt-5">
        ...
        <div class="row mt-3">
          ...
          <div class="col-md-3 col-lg-4 col-xl-3 mx-auto mb-4">
            <!-- Content -->
            <h6 style="color: pink;" class="text-uppercase fw-bold mb-4">
              <i class="fas fa-gem me-3"></i>𝑩𝒆𝒍𝒍𝒂 𝑽𝒊𝒔𝒂𝒈𝒆
            </h6>
            <p>
          ...
          <div class="col-md-4 col-lg-3 col-xl-3 mx-auto mb-md-0 mb-4">
            <!-- Links -->
            <h6 class="text-uppercase fw-bold mb-4">𝐂𝐨𝐧𝐭𝐚𝐜𝐭</h6>
            <p><i class="fas fa-home me-3"></i> Cape Town, WC 10012, ZA</p>
            <p>
              <i class="fas fa-envelope me-3"></i>
              𝑩𝒆𝒍𝒍𝒂 𝑽𝒊𝒔𝒂𝒈𝒆@gmail.com  
            </p>
    ...
    <div class="text-center p-4" style="background-color:#D78976; color: white;">
      © 2023 𝐂𝐨𝐩𝐲𝐫𝐢𝐠𝐡𝐭 | 𝑩𝒆𝒍𝒍𝒂 𝑽𝒊𝒔𝒂𝒈𝒆</div>
    <!-- Copyright -->
  </footer>
  <!-- Footer -->
